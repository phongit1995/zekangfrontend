...
function Introduce(props) {
    return (
        <React.Fragment>
            ...
            <Container>
                <Row>
                    <Col lg={6} md={6} sm={6} className="inf-img ing-img_">
                        <div className="profZ">
                            <div>
                            <span>
                    ...
                    <Col lg={6} md={6} sm={6} className="inf-img">
            ...
            <div className="distant distant__"></div>
            <Container>
                <Row>
                    <Col lg={6} md={6} sm={6} className="inf-img inf-img-0">
                        <div className="infAboutImg_">
                            <div className="infAboutImg">
